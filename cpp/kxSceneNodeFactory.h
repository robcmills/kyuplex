...
#ifndef __KX_SCENE_NODE_FACTORY_H_INCLUDED__
#define __KX_SCENE_NODE_FACTORY_H_INCLUDED__
...
//{
	...
	class kxSceneNodeFactory : public ISceneNodeFactory
	{
	public:

		kxSceneNodeFactory( ISceneManager* mgr );
	...
	private:
		...
		core::array<SSceneNodeTypePair> kxSceneNodeTypes;
